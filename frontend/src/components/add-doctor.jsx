  ...
  return (
    <div className="bg-blue-600 text-white p-8 rounded-lg shadow-lg w-96">
      ...
      <div className="space-y-4">
        <p>Full Name: <span className="font-bold text-yellow-300">Joe Bob</span></p>
        <p>Username: <span className="font-bold text-yellow-300">jbob</span></p>
        <p>Password: <span className="font-bold text-yellow-300">****</span></p>
        <p>Email: <span className="font-bold text-yellow-300">jb@gmail.com</span></p>
        <p>Contact Number: <span className="font-bold text-yellow-300">9000000</span></p>
        <p>Role: <span className="font-bold text-yellow-300">Doctor</span></p>
      </div>
      <button
